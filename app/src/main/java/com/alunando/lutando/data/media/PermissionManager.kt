package com.alunando.lutando.data.media
...
class PermissionManager(private val context: Context) {
     ...
     */
    fun getRequiredPermissions(mediaType: com.alunando.lutando.domain.model.MediaType): Array<String> {
        val permissions = mutableListOf<String>()

        when (mediaType) {
            com.alunando.lutando.domain.model.MediaType.PHOTO -> {
            ...
            com.alunando.lutando.domain.model.MediaType.VIDEO -> {
                permissions.add(Manifest.permission.CAMERA)
            ...
            com.alunando.lutando.domain.model.MediaType.AUDIO -> {
                permissions.add(Manifest.permission.RECORD_AUDIO)
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
     ...
     */
    fun hasAllRequiredPermissions(mediaType: com.alunando.lutando.domain.model.MediaType): Boolean {
